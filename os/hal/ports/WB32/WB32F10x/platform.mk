...
PLATFORMSRC_CONTRIB := $(CHIBIOS)/os/hal/ports/common/ARMCMx/nvic.c \
               $(CHIBIOS_CONTRIB)/os/hal/ports/WB32/WB32F10x/hal_lld.c \
               $(CHIBIOS_CONTRIB)/os/hal/ports/WB32/WB32F10x/wb32f10x_rcc.c \
               $(CHIBIOS_CONTRIB)/os/hal/ports/WB32/WB32F10x/wb32f10x_bkp.c \
               $(CHIBIOS_CONTRIB)/os/hal/ports/WB32/WB32F10x/wb32f10x_anctl.c \
               $(CHIBIOS_CONTRIB)/os/hal/ports/WB32/WB32F10x/wb32f10x_pwr.c \

# Required include directories.
PLATFORMINC_CONTRIB := $(CHIBIOS)/os/hal/ports/common/ARMCMx \
               $(CHIBIOS_CONTRIB)/os/hal/ports/WB32/WB32F10x
