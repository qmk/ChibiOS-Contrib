...
void _pal_lld_init(const PALConfig *config) {
   ...
   */
#if defined(WB32_HAS_GPIOA) || defined(WB32_HAS_GPIOB) || defined(WB32_HAS_GPIOC) || defined(WB32_HAS_GPIOD)
   RCC->APB1ENR |= (1<<15);
#endif
...
#endif
  /*
   * @brief  Initial GPIOA setup.
   */
#if WB32_HAS_GPIOA
  _pal_lld_setgroupmode(GPIOA,config->PAData.GPIO_Pin,config->PAData.PinConfig);
#endif
  /*
   * @brief  Initial GPIOB setup.
   */
#if WB32_HAS_GPIOB
  _pal_lld_setgroupmode(GPIOB,config->PBData.GPIO_Pin,config->PBData.PinConfig);
#endif
  /*
   * @brief  Initial GPIOC setup.
   */
#if WB32_HAS_GPIOC
  _pal_lld_setgroupmode(GPIOC,config->PCData.GPIO_Pin,config->PCData.PinConfig);
#endif
  /*
   * @brief  Initial GPIOD setup.
   */
#if WB32_HAS_GPIOD
  _pal_lld_setgroupmode(GPIOD,config->PDData.GPIO_Pin,config->PDData.PinConfig);
#endif
}
