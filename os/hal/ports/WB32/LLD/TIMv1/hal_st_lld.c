...
#define ST_ENABLE_CLOCK()                   RCC_APB1PeriphClockCmd(RCC_APB1Periph_TIM2, ENABLE)
#if defined(WB32F10x)
...
#define ST_CLOCK_SRC                        WB32_TIMCLK1
#define ST_ENABLE_CLOCK()                   RCC_APB1PeriphClockCmd(RCC_APB1Periph_TIM3, ENABLE)
#if defined(WB32F10x)
...
#define ST_CLOCK_SRC                        WB32_TIMCLK1
#define ST_ENABLE_CLOCK()                   RCC_APB1PeriphClockCmd(RCC_APB1Periph_TIM4, ENABLE)
#if defined(WB32F10x)
