...
const wb32_dma_stream_t _WB32_DMAC_CHANNELS[WB32_DMAC_CHANNELS] = {
    ...
    {DMAC1, DMAC_Channel_0, WB32_DMAC1_CH0_CMASK, 0, WB32_DMAC1_NUMBER},
#endif
#if WB32_DMAC1_NUM_CHANNELS > 1
    {DMAC1, DMAC_Channel_1, WB32_DMAC1_CH1_CMASK, 1, WB32_DMAC1_NUMBER},
#endif
#if WB32_DMAC1_NUM_CHANNELS > 2
    {DMAC1, DMAC_Channel_2, WB32_DMAC1_CH2_CMASK, 2, WB32_DMAC1_NUMBER},
#endif
#if WB32_DMAC2_NUM_CHANNELS > 0
    {DMAC2, DMAC_Channel_0, WB32_DMAC2_CH0_CMASK, 0 + WB32_DMAC1_NUM_CHANNELS, WB32_DMAC2_NUMBER},
#endif
#if WB32_DMAC2_NUM_CHANNELS > 1
    {DMAC2, DMAC_Channel_1, WB32_DMAC2_CH1_CMASK, 1 + WB32_DMAC1_NUM_CHANNELS, WB32_DMAC2_NUMBER},
#endif
#if WB32_DMAC2_NUM_CHANNELS > 2
    {DMAC2, DMAC_Channel_2, WB32_DMAC2_CH2_CMASK, 2 + WB32_DMAC1_NUM_CHANNELS, WB32_DMAC2_NUMBER},
#endif
};
...
void dmaStreamFreeI(const wb32_dma_stream_t *dmastp)
{
  ...
  {
    /* Disable DMAC1 clock */
    RCC_AHBPeriphClockCmd(RCC_AHBPeriph_DMAC1Bridge, DISABLE);
    RCC_APB1PeriphClockCmd(RCC_APB1Periph_BMX1 | RCC_APB1Periph_DMAC1, DISABLE);
  }
#if WB32_DMAC2_NUM_CHANNELS > 0
  if ((dma.allocated_mask & WB32_DMA2_STREAMS_MASK) == 0U)
  {
     /* Disable DMAC2 clock */
    RCC_AHBPeriphClockCmd(RCC_AHBPeriph_DMAC2Bridge, DISABLE);
    RCC_APB2PeriphClockCmd(RCC_APB2Periph_BMX2 | RCC_APB2Periph_DMAC2, DISABLE);
  }
#endif
...
void dmaServeInterrupt(const wb32_dma_stream_t *dmastp)
{
  ...
  uint32_t regaddr = ((uint32_t)(&((dmastp)->dmac->StatusTfr)) + DMAC_IT_TFR);
  ...
  if ((*((__I uint32_t *)(regaddr))) & mask)
  {
    ...
    {
      // dma.streams[selfindex].func((dmastp)->dmac, (dmastp)->dmac_channel, IT_flag);
       dma.streams[selfindex].func(dma.streams[selfindex].param, IT_flag);
    }
  }

  regaddr = ((uint32_t)(&((dmastp)->dmac->StatusTfr)) + DMAC_IT_BLOCK);

  if ((*((__I uint32_t *)(regaddr))) & mask)
  {
    IT_flag = DMAC_IT_BLOCK;
    if (dma.streams[selfindex].func)
    {
      dma.streams[selfindex].func(dma.streams[selfindex].param, IT_flag);
    }
  ...
  regaddr = ((uint32_t)(&((dmastp)->dmac->StatusTfr)) + DMAC_IT_SRCTRAN);

  if ((*((__I uint32_t *)(regaddr))) & mask)
  {
    IT_flag = DMAC_IT_SRCTRAN;
    if (dma.streams[selfindex].func)
    {
      dma.streams[selfindex].func(dma.streams[selfindex].param, IT_flag);
    }
  ...
  regaddr = ((uint32_t)(&((dmastp)->dmac->StatusTfr)) + DMAC_IT_DSTTRAN);

  if ((*((__I uint32_t *)(regaddr))) & mask)
  {
    IT_flag = DMAC_IT_DSTTRAN;
    if (dma.streams[selfindex].func)
    {
      dma.streams[selfindex].func(dma.streams[selfindex].param, IT_flag);
    }
  ...
  regaddr = ((uint32_t)(&((dmastp)->dmac->StatusTfr)) + DMAC_IT_ERR);
